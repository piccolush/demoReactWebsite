...
export default class About extends Component {
  render() {
    return (
      <div>
        <Image src="assets/food-people.jpg" className="header-image" />
        <Grid fluid= 'true'>
          <Col xs={12} sm={8}  lg={6}>
            <Image src="assets/food-1.jpg" className="about-profile-pic" responsive rounded />
            <h3>Fish Fillet</h3>
          ...
          <Col xs={12} lg={6}>
            <HotelForm onClick={this.props.onClick}/>
          </Col>
        </Grid>
      </div>
    )
